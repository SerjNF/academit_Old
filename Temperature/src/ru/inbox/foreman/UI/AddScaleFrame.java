...
class AddScaleFrame {
    ...
    private JPanel inputPanel() {
        ...
        kC.add(k2Label);
        kC.add(k2);
        JLabel k3Labe = new JLabel("k3:");
        k3Labe.setHorizontalAlignment(SwingConstants.RIGHT);
        kC.add(k3Labe);
        kC.add(k3);
        ...
        JLabel k4Label = new JLabel("k4:");
        k4Label.setHorizontalAlignment(SwingConstants.RIGHT);
        kR.add(k4Label);
        kR.add(k4);
        JLabel k5Label = new JLabel("k5:");
        k5Label.setHorizontalAlignment(SwingConstants.RIGHT);
        kR.add(k5Label);
        kR.add(k5);
        JLabel k6Label = new JLabel("k6:");
        k6Label.setHorizontalAlignment(SwingConstants.RIGHT);
        kR.add(k6Label);
        kR.add(k6);
